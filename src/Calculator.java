...
public class Calculator
{
    ...
    protected static int calculateTwoTokens(String[] tokens) throws NumberFormatException, CalculatorException
    {
        ...
        if (b.equalsIgnoreCase("negate")) {
        	return a * -1;
        } else if (b.equalsIgnoreCase("halve")) {
        	return a / 2;
        } else {
            ...
            throws ArithmeticException, NumberFormatException, CalculatorException
    {
        // TODO: complete this... 
    	 ...
    	 // Throws NumberFormatException if the first or third token is not an int value.
    	 ...
    	 if (c.equals("+")) {
    		 ...
    		 return (a / b); // throws Arithmetic exception automatically if b = 0
    	 } else {
    		 throw new CalculatorException("Illegal Command");
    	 }
