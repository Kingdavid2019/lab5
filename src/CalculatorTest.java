...
public class CalculatorTest {
    ...
    public void calculateThreeTokensTestValidAdd() throws AssertException
    {
    	...
    	int result = Calculator.calculateThreeTokens(new String[] {"1", "+", "11"});
    ...
    public void calculateThreeTokensTestValidSubtract() throws AssertException
    {
    	...
    	try {
        	...
        	int result = Calculator.calculateThreeTokens(new String[] {"20", "-", "2"});
    ...
    public void calculateThreeTokensTestValidDivide() throws AssertException
    {
    	...
    	try {
        	...
        	int result = Calculator.calculateThreeTokens(new String[] {"42", "/", "3"});
    ...
    public void calculateThreeTokensTestInvalidCommand() throws AssertException
    {
        // TODO: complete this test...
    	try {
    	Calculator.calculateThreeTokens(new String[] {"1", "foo", "5"});
    	Assert.fail("Illegal expression did not throw an Exception");
    	} catch (CalculatorException e) {
    		//Success
    	} catch (Exception e) {
    ...
    public void executeTestValidThreeTokens() throws AssertException
    {
    	...
    	try
        {
            int result = Calculator.execute(new String[] {"10", "-", "5"});
            Assert.assertEquals(5, result);
        }
        catch (Exception e)
        {
    ...
    public void executeTestInvalidTokenLength() throws AssertException
    {
        ...
        // TODO: complete this test...
    	try {
    		String[] strg1 = new String[0];
    		Calculator.execute(strg1);
    		Assert.fail("Illegal expression did not throw an Exception");
    	} catch (CalculatorException e) {
    		//success
    	} catch (Exception e) {
        ...
        // TODO: complete this test...
    	try {
    		String[] strg2 = new String[4]; 
    		Calculator.execute(strg2);
    		Assert.fail("Illegal expression did not throw an Exception");
    	} catch(CalculatorException e) {
    		//Success
    	} catch (Exception e) {
